...
import deeplook.server.global.common.auth.oauth.dto.OAuthAttributes;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        */
         ...
         */
        User user = saveOrUpdate(attributes,"KAKAO");
    ...
    private User saveOrUpdate(OAuthAttributes attributes,String registrationId) {
        User user = userRepository.findByOid(attributes.getOid())
